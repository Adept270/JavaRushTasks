...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getFilledList() {
            ...
            List<PhantomReference<Monkey>> phantomRefMonkey = new ArrayList<>();

            while (phantomRefMonkey.size() < 200) {
                Monkey monkey = new Monkey();
                phantomRefMonkey.add(new PhantomReference<Monkey>(monkey, helper.getQueue()));
            }

            return phantomRefMonkey;
        }
