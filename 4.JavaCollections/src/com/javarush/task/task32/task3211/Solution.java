...
public class Solution {
    ...
    public static boolean compareMD5(ByteArrayOutputStream byteArrayOutputStream, String md5) throws Exception {
        ...
        byte[] bytesMd5 = messageDigest.digest();
        BigInteger bigInteger = new BigInteger(1, bytesMd5);
        String hexMd5 = bigInteger.toString(16);

        while (hexMd5.length() < 32) {
            hexMd5 = "0" + hexMd5;
        }

        return hexMd5.equals(md5);
